...
export default function Home() {
  ...
  return (
    <div className="flex flex-col flex-1 w-full bg-background">
      <header className="sticky top-0 z-20 flex h-14 items-center gap-3 border-b border-border/40 bg-background/90 backdrop-blur-xl w-full px-4">
        ...
        <div className="ml-auto flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] font-bold uppercase tracking-widest" style={{ color: marketState.color }}>
              {marketState.label}
            </span>
          </div>
          <div className="flex items-center gap-2">
      ...
      <main className="flex-1 w-full max-w-5xl mx-auto px-6 py-8 space-y-10">
        <OnboardingChecklist
        ...
        <section>
          ...
          {isReady ? (
            <>
              <h1 className="text-6xl md:text-8xl font-bold font-mono tracking-tight mt-2 leading-none">
